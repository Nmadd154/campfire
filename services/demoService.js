...
let mockCampsites = [
  {
    $id: "1",
    name: "McKenzie River Campground",
    description:
      "Beautiful riverside camping along the scenic McKenzie River with crystal clear water",
    latitude: 44.1892,
    longitude: -122.1547,
    isPrivate: false,
    addedBy: "demo-user-1",
  ...
  },
  {
    ...
    description:
      "Pristine mountain lake camping with stunning Cascade views and hiking trails",
    latitude: 44.3703,
    longitude: -121.9928,
    isPrivate: false,
    addedBy: "demo-user-1",
  ...
  {
    $id: "3",
    name: "Cougar Reservoir Campground",
    description: "Peaceful lakeside camping perfect for kayaking and fishing",
    latitude: 44.1289,
    longitude: -122.2434,
    isPrivate: false,
    addedBy: "demo-user-1",
    amenities: ["Water", "Restrooms", "Boat Launch", "Fishing"],
    photos: [],
    createdAt: new Date().toISOString(),
  },
];
